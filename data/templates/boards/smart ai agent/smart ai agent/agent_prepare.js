...
let invisibleActions = [ name, "agent_input", "reply", "reset", "agent_core",  "user_request", "agent_prepare"]
let visibleStates = params.full_board_view ? ['*'] : params.values
let invisibleStates = [ name, "agent_input", "reply", "reset", "agent_core","user_request" ]
